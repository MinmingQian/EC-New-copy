 ...
 */
public class FitnessProportionalSelectionTest {
    ...
    public void testSelection() throws Exception {
        ...
        FitnessProportionalSelection<PermutationRepresentation> selection =new FitnessProportionalSelection<>();
        selection.selection(5,solutionSpace).forEach(solution -> System.out.println(solution.getRepresentation().getRepresentationString()));
